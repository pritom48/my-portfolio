            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                <div class="card w-96 bg-slate-700 shadow-xl">
                    ...
                    <div class="card-body text-white">
                        ...
                        <button class="btn btn-outline text-white"><a href="https://computer-tools-502a0.web.app/">Live Site</a></button>
                        <button class="btn btn-outline text-white"><a href="https://github.com/pritom48/ass-12-computer-tools">Github</a></button>
                    </div>
                </div>
                <div class="card w-96 bg-slate-700 shadow-xl">
                    <figure class="px-10 pt-10">
                    ...
                    <div class="card-body text-white">
                        ...
                        <button class="btn btn-outline text-white"><a href="https://bicycle-house-cda08.web.app/">Live Site</a></button>
                        <button class="btn btn-outline text-white"><a href="https://github.com/pritom48/ass-11-bicycle-house-client">Github</a></button>
                    </div>
                </div>
                <div class="card w-96 bg-slate-700 shadow-xl">
                    <figure class="px-10 pt-10">
                    ...
                    <div class="card-body text-white">
                        ...
                        <button class="btn btn-outline text-white"><a href="https://photo-hunter-cb937.web.app/">Live Site</a></button>
                        <button class="btn btn-outline text-white"><a href="https://github.com/pritom48/picture-hunt">Github</a></button>
